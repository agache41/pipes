...
package examples.excel.multiSheetWithPosition;
...
public class ExcelTest {
    private final String testFileName = "excel3MultiSheet.xlsx";
    ...
    void test() throws Throwable {
        ...
        assertThat(expected.getSheet3()
                           .collect(Collectors.toList())).hasSameElementsAs(readout.getSheet3()
                                                                                   .collect(Collectors.toList()));
    ...
    public ExcelTestMultiBean createBean() {
        ...
        l2.add(ExcelSheetTestBean2.builder()
                                  ...
                                  .list7(Arrays.asList("1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a"))
                                  .build());
        List<ExcelSheetTestBean3> l3 = new LinkedList<>();
        l3.add(ExcelSheetTestBean3.builder()
                                  .string0("")
                                  .integer1(Integer.MIN_VALUE)
                                  .long2(Long.MIN_VALUE)
                                  .double3(Double.MIN_VALUE)
        ...
        bean.setSheet2(l3.stream());
        bean.setSheet3(l2.stream());
        return bean;
    }
}
