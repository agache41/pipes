...
public class ExcelTestMultiBean {
    ...
    @Pipe.ofClass(ExcelSheetTestBean3.class)
    @Accessor
    private Stream<ExcelSheetTestBean3> sheet2;

    @Position(3)
    @SpreadSheet.select(sheetName = "ExcelTestBean3")
    @Pipe.ofClass(ExcelSheetTestBean2.class)
    @Accessor
    private Stream<ExcelSheetTestBean2> sheet3;
}
