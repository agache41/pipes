...
import com.orm.pipes.baseTest.AbstractBaseObjectTest;
...
class ExcelMultisheetTest extends AbstractBaseObjectTest<ExcelTestMultiBean> {
    ...
    private final ExcelTestMultiBean bean = new ExcelTestMultiBean();

    public ExcelMultisheetTest() {
