...
@CSVFile(namingMethod = NamingMethod.JavaFieldNames, positionMethod = PositionMethod.Fields, model = Model.VariableNames)
public class FieldFieldsTestBean extends BaseCSVTestBean {
}
